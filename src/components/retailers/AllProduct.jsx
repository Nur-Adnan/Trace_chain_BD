...
function AllProduct() {
  ...
  const dummyData = [
    ...
    },
    {
      ...
      price: "50",
      importedDate: 1632667999,
      importerAddr: "0xABC...",
      customsAddr: "0xDEF...",
      owner: "0xGHI...", // Different owner to show "Sold" status
    },
  ];

  useEffect(() => {
    // Commented out for dummy data usage
    /*
    ...
    */
    ...
    // Set dummy data
    setDeliveredProducts(dummyData);
    setLoading(false);
  ...
  return (
    <div className="px-2 py-5 w-full min-h-screen bg-cover bg-center flex flex-col mt-4">
      ...
      <p className="text-lg mb-8 max-w-xl mx-auto drop-shadow-md tracking-wider leading-8">
        List of all the products accepted by you and their sell status
      </p>
            ...
            <table className="w-full bg-white rounded-lg">
              <thead className="border-b border-gray-300 bg-gray-100 ">
                <tr className="text-black text-sm font-inter uppercase tracking-wider">
                  ...
                  <th className="p-4 text-center text-gray-800 font-semibold">
                    Sell Status
                  </th>
                </tr>
              </thead>
