...
function AllDistributorList() {
  ...
  useEffect(() => {
    // Commenting out the real data fetch and using dummy data for display
    /*
    ...
    */
    ...
    const dummyData = [
      {
        name: "John Doe",
        address_registered: "0x1234567890abcdef1234567890abcdef12345678",
        countryOfOrigin: "USA",
        role: "DISTRIBUTOR",
        locAddress: "123 Main St, Anytown",
        contractNumber: "123-456-7890",
      },
      {
        name: "Jane Smith",
        address_registered: "0xabcdefabcdefabcdefabcdefabcdefabcdefabcdef",
        countryOfOrigin: "Canada",
        role: "DISTRIBUTOR",
        locAddress: "456 Maple Ave, Othertown",
        contractNumber: "987-654-3210",
      },
      {
        name: "Acme Corp",
        address_registered: "0xdeadbeefdeadbeefdeadbeefdeadbeefdeadbeef",
        countryOfOrigin: "Germany",
        role: "DISTRIBUTOR",
        locAddress: "789 Elm St, Anothertown",
        contractNumber: "555-555-5555",
      },
    ];
    setImporters(dummyData);
    setLoading(false);
  }, []);
  ...
  return (
    <div className="px-2 py-5 w-full min-h-screen bg-cover bg-center flex flex-col mt-4">
      ...
      <p className="text-lg mb-8 max-w-xl mx-auto drop-shadow-md tracking-wider leading-8">
        List of all the distributors whom you can send products
      </p>
      {importers.length > 0 ? (
